...
set(CMAKE_FIND_ROOT_PATH
  "${RTEMS_PREFIX}/${RTEMS_BSP}"
  "${RTEMS_PREFIX}"
)
set(CMAKE_SYSTEM_PREFIX_PATH ${CMAKE_FIND_ROOT_PATH})

set(CMAKE_SYSTEM_INCLUDE_PATH
  "${RTEMS_PREFIX}/${RTEMS_BSP}/include"
  "${RTEMS_PREFIX}/include"
)
...
set(CMAKE_PLATFORM_IMPLICIT_LINK_DIRECTORIES
  "${RTEMS_PREFIX}/${RTEMS_BSP}/lib"
)
set(CMAKE_SYSTEM_LIBRARY_PATH ${CMAKE_PLATFORM_IMPLICIT_LINK_DIRECTORIES})

set(CMAKE_C_FLAGS_INIT
 "-B${RTEMS_PREFIX}/${RTEMS_BSP}/lib/ -specs bsp_specs -qrtems ${RTEMS_BSP_C_FLAGS}"
)
set(CMAKE_C_FLAGS_INIT ${CMAKE_C_FLAGS_INIT})

set(CMAKE_EXE_LINKER_FLAGS "-u Init")
foreach(ldpart ${RTEMS_LDPARTS})
  set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${RTEMS_PREFIX}/${RTEMS_BSP}/lib/${ldpart}")
endforeach()
